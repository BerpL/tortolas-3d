...
eventHTMLElem('click', 'menu_principal', false, function(event) {
  setHTMLElemAttribute('innerHTML', '4500 FLOTACIÓN COLECTIVA DE LT2', 'tituloEquipo', false);
  ...
  setHTMLElemStyle('display', 'none', 'volver_submenu_3', false);
  setHTMLElemStyle('display', 'flex', 'menu_principal_collapse', false);
  setHTMLElemStyle('display', 'none', 'siguiente_9_1', false);
  setHTMLElemStyle('display', 'none', 'siguiente_9_2', false);
  setHTMLElemStyle('display', 'none', 'siguiente_9_3', false);
});
...
eventHTMLElem('click', 'equipo_1_1', false, function(event) {
  ...
  Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('window.parent.postMessage({param1: 1, param2:175 },\'*\');' + '\n' +
  ...
  registerOnHover('4510SAL002', false, function() {
    if (is_eq_1_1 == true) {
...
eventHTMLElem('click', 'equipo_1_2', false, function(event) {
  ...
  registerOnHover('4510FTR001A024', false, function() {
    if (is_eq_1_2 == true) {
      setHTMLElemAttribute('style', 'cursor:pointer;', ['BODY'], false);
    }
  }, function() {
...
eventHTMLElem('click', 'equipo_1_3', false, function(event) {
  ...
  registerOnHover(['4510SAL004', '4510SAL016', '4510SAL017'], false, function() {
    if (is_eq_1_3 == true) {
      setHTMLElemAttribute('style', 'cursor:pointer;', ['BODY'], false);
    }
  }, function() {
...
eventHTMLElem('click', 'equipo_1_4', false, function(event) {
  ...
  registerOnHover(['4510SAL003', '4510SAL300', null], false, function() {
    if (is_eq_1_4 == true) {
      setHTMLElemAttribute('style', 'cursor:pointer;', ['BODY'], false);
    }
  }, function() {
...
eventHTMLElem('click', 'equipo_2_1', false, function(event) {
  ...
  registerOnHover('4530PPS012A14', false, function() {
    if (is_eq_2_1 == true) {
      setHTMLElemAttribute('style', 'cursor:pointer;', ['BODY'], false);
    }
  }, function() {
...
eventHTMLElem('click', 'equipo_2_2', false, function(event) {
  ...
  tweenCamera('Camara006', 'CamaraDireccion006', 1, function() {
    outline('4530CSC003Y004', 'ENABLE');
    setHTMLElemStyle('display', 'flex', 'volver_submenu_2', false);
  }, 0);
  registerOnHover('4530CSC003Y004', false, function() {
    if (is_eq_2_2 == true) {
      setHTMLElemAttribute('style', 'cursor:pointer;', ['BODY'], false);
    }
  }, function() {
...
eventHTMLElem('click', 'equipo_2_3', false, function(event) {
  ...
  registerOnHover('4530MLT001A003', false, function() {
    if (is_eq_2_3 == true) {
      setHTMLElemAttribute('style', 'cursor:pointer;', ['BODY'], false);
    }
  }, function() {
...
eventHTMLElem('click', 'equipo_2_4', false, function(event) {
  ...
  registerOnHover('4530PPS009A011', false, function() {
    if (is_eq_2_4 == true) {
      setHTMLElemAttribute('style', 'cursor:pointer;', ['BODY'], false);
    }
  }, function() {
...
eventHTMLElem('click', 'volver_submenu_3', false, function(event) {
  if (is_opened_submenu3 == false) {
    ...
    setHTMLElemStyle('display', 'flex', 'submenu_3_opciones', false);
    setHTMLElemStyle('display', 'none', ['siguiente_9_1', 'siguiente_9_2', 'siguiente_9_3'], false);
  } else {
    is_opened_submenu3 = false;
    setHTMLElemStyle('display', 'none', 'submenu_3_opciones', false);
    setHTMLElemStyle('display', 'none', ['siguiente_9_1', 'siguiente_9_2', 'siguiente_9_3'], false);
...
eventHTMLElem('click', 'equipo_3_1', false, function(event) {
  ...
  Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', 'window.parent.postMessage({param1: 1, param2:165 },\'*\');')(appInstance, v3d, PL, VARS, PROC);
  ...
  registerOnHover('4530PPS028Y029', false, function() {
    if (is_eq_3_1 == true) {
      setHTMLElemAttribute('style', 'cursor:pointer;', ['BODY'], false);
    }
  }, function() {
...
eventHTMLElem('click', 'equipo_3_2', false, function(event) {
  ...
  registerOnHover('4530FTC002Y004', false, function() {
    if (is_eq_3_2 == true) {
      setHTMLElemAttribute('style', 'cursor:pointer;', ['BODY'], false);
    }
  }, function() {
...
eventHTMLElem('click', 'equipo_3_3', false, function(event) {
  ...
  registerOnHover('4530FTC003Y005', false, function() {
    if (is_eq_3_3 == true) {
      setHTMLElemAttribute('style', 'cursor:pointer;', ['BODY'], false);
    }
  }, function() {
...
eventHTMLElem('click', 'equipo_3_4', false, function(event) {
  ...
  registerOnHover('4530PPS208Y209', false, function() {
    if (is_eq_3_4 == true) {
      setHTMLElemAttribute('style', 'cursor:pointer;', ['BODY'], false);
    }
  }, function() {
...
eventHTMLElem('click', 'equipo_3_5', false, function(event) {
  ...
  registerOnHover('4530SAL005', false, function() {
    if (is_eq_3_5 == true) {
      setHTMLElemAttribute('style', 'cursor:pointer;', ['BODY'], false);
    }
  }, function() {
...
eventHTMLElem('click', 'equipo_3_6', false, function(event) {
  ...
  registerOnHover('4530PPS212Y213', false, function() {
    if (is_eq_3_6 == true) {
      setHTMLElemAttribute('style', 'cursor:pointer;', ['BODY'], false);
    }
  }, function() {
...
eventHTMLElem('click', 'equipo_3_7', false, function(event) {
  ...
  registerOnHover('4530FTA001A008', false, function() {
    if (is_eq_3_7 == true) {
      setHTMLElemAttribute('style', 'cursor:pointer;', ['BODY'], false);
    }
  }, function() {
...
eventHTMLElem('click', 'equipo_3_8', false, function(event) {
  ...
  registerOnHover('4530SAL006', false, function() {
    if (is_eq_3_8 == true) {
      setHTMLElemAttribute('style', 'cursor:pointer;', ['BODY'], false);
    }
  }, function() {
...
eventHTMLElem('click', 'equipo_3_9', false, function(event) {
  ...
  Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('window.parent.postMessage({param1: 1, param2:173 },\'*\');' + '\n' +
  '')))(appInstance, v3d, PL, VARS, PROC);
  ...
  tweenCamera('Camara017', 'CamaraDireccion017', 1, function() {
    ...
    setHTMLElemStyle('display', 'flex', 'volver_submenu_3', false);
    setHTMLElemStyle('display', 'flex', 'siguiente_9_1', false);
    eventHTMLElem('click', 'siguiente_9_1', false, function(event) {
      setHTMLElemStyle('display', 'none', 'siguiente_9_1', false);
      tweenCamera('Camara019', 'CamaraDireccion019', 1, function() {
        setHTMLElemStyle('display', 'flex', 'siguiente_9_2', false);
      }, 0);
    });
    eventHTMLElem('click', 'siguiente_9_2', false, function(event) {
      setHTMLElemStyle('display', 'none', 'siguiente_9_2', false);
      tweenCamera('Camara020', 'CamaraDireccion020', 1, function() {
        setHTMLElemStyle('display', 'flex', 'siguiente_9_3', false);
      }, 0);
    });
    eventHTMLElem('click', 'siguiente_9_3', false, function(event) {
      setHTMLElemStyle('display', 'none', 'siguiente_9_3', false);
      tweenCamera('Camara017', 'CamaraDireccion017', 1, function() {
        setHTMLElemStyle('display', 'flex', 'siguiente_9_1', false);
      }, 0);
  ...
  registerOnHover(['4530PPS242Y244', null, '4530PPS243Y245'], false, function() {
    if (is_eq_3_9 == true) {
      setHTMLElemAttribute('style', 'cursor:pointer;', ['BODY'], false);
    }
  }, function() {
...
eventHTMLElem('click', 'equipo_3_10', false, function(event) {
  ...
  Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('window.parent.postMessage({param1: 1, param2:174 },\'*\');' + '\n' +
  '')))(appInstance, v3d, PL, VARS, PROC);
  ...
  registerOnHover('4550PPS201A210', false, function() {
    if (is_eq_3_10 == true) {
      setHTMLElemAttribute('style', 'cursor:pointer;', ['BODY'], false);
    }
  }, function() {
