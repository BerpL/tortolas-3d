...
this.procedures["eventoEquipos"] = eventoEquipos;

var PROC = {
    "eventoEquipos": eventoEquipos,
};

var is_ft_loaded, equipo_id, submenu_opciones, pos, dir, objeto, info, infoContainer, infoContainerBtnCerrar, idPostSend, selected, arnes_1, arnes_2, linea_de_vida_1, linea_de_vida_2, vara_en_el_suelo_1, etiqueta_roja_1;
...
function eventoEquipos(equipo_id, submenu_opciones, pos, dir, objeto, info, infoContainer, infoContainerBtnCerrar, idPostSend) {
var VARS = Object.defineProperties({}, {
  ...
  eventHTMLElem('click', equipo_id, false, function(event) {
    outline(['ALL_OBJECTS'], 'DISABLE');

    Function('app', 'v3d', 'puzzles', 'VARS', 'PROC', (('let value = VARS[\'idPostSend\'];' + '\n' +
    'console.log(value)' + '\n' +
    'window.parent.postMessage({param1: value});')))(appInstance, v3d, PL, VARS, PROC);

    setHTMLElemStyle('display', 'none', submenu_opciones, false);
    tweenCamera(pos, dir, 1, function() {
      outline(objeto, 'ENABLE');
    }, 0);
  });
  registerOnClick(objeto, false, false, [0,1,2], function() {
    outline(info, 'DISABLE');
    setHTMLElemStyle('display', 'flex', infoContainer, false);
  }, function() {});
  eventHTMLElem('click', infoContainerBtnCerrar, false, function(event) {
    setHTMLElemStyle('display', 'none', infoContainer, false);
  });
}
...
eventoEquipos('equipo_1_1', 'submenu_1_opciones', 'Camara001', 'CamaraDireccion001', ['4510SAL002', null, null], 'Informacion001', 'info_equipo_1_1', 'info_equipo_1_1_btnCerrar', '155');
eventoEquipos('equipo_1_2', 'submenu_1_opciones', 'Camara002', 'CamaraDireccion002', ['4510FTR001A024', null, null], 'Informacion002', 'info_equipo_1_2', 'info_equipo_1_2_btnCerrar', '158');
eventoEquipos('equipo_1_3', 'submenu_1_opciones', 'Camara003', 'CamaraDireccion003', ['4510SAL004016017', null, null], 'Informacion003', 'info_equipo_1_3', 'info_equipo_1_3_btnCerrar', '157');
eventoEquipos('equipo_1_4', 'submenu_1_opciones', 'Camara004', 'CamaraDireccion004', ['4510SAL003Y300', null, null], 'Informacion004', 'info_equipo_1_4', 'info_equipo_1_4_btnCerrar', '156');

eventoEquipos('equipo_2_1', 'submenu_2_opciones', 'Camara005', 'CamaraDireccion005', ['4530PPS012A14', null, null], 'Informacion006', 'info_equipo_2_1', 'info_equipo_2_1_btnCerrar', '159');
eventoEquipos('equipo_2_2', 'submenu_2_opciones', 'Camara006', 'CamaraDireccion006', ['4530CSC003Y004', null, null], 'Informacion006', 'info_equipo_2_2', 'info_equipo_2_2_btnCerrar', '160');
eventoEquipos('equipo_2_3', 'submenu_2_opciones', 'Camara007', 'CamaraDireccion007', ['4530MLT001A003', null, null], 'Informacion007', 'info_equipo_2_3', 'info_equipo_2_3_btnCerrar', '161');
eventoEquipos('equipo_2_4', 'submenu_2_opciones', 'Camara008', 'CamaraDireccion008', ['4530PPS009A011', null, null], 'Informacion008', 'info_equipo_2_4', 'info_equipo_2_4_btnCerrar', '162');

eventoEquipos('equipo_3_1', 'submenu_3_opciones', 'Camara009', 'CamaraDireccion009', ['4530PPS028Y029', null, null], 'Informacion009', 'info_equipo_3_1', 'info_equipo_3_1_btnCerrar', '163');
eventoEquipos('equipo_3_2', 'submenu_3_opciones', 'Camara010', 'CamaraDireccion010', ['4530FTC002Y004', null, null], 'Informacion010', 'info_equipo_3_2', 'info_equipo_3_2_btnCerrar', '164');
eventoEquipos('equipo_3_3', 'submenu_3_opciones', 'Camara011', 'CamaraDireccion011', ['4530FTC003Y005', null, null], 'Informacion011', 'info_equipo_3_3', 'info_equipo_3_3_btnCerrar', '165');
eventoEquipos('equipo_3_4', 'submenu_3_opciones', 'Camara012', 'CamaraDireccion012', ['4530PPS208Y209', null, null], 'Informacion012', 'info_equipo_3_4', 'info_equipo_3_4_btnCerrar', '166');
eventoEquipos('equipo_3_5', 'submenu_3_opciones', 'Camara013', 'CamaraDireccion013', ['4530SAL005', null, null], 'Informacion013', 'info_equipo_3_5', 'info_equipo_3_5_btnCerrar', '167');
eventoEquipos('equipo_3_6', 'submenu_3_opciones', 'Camara014', 'CamaraDireccion014', ['4530PPS212Y213', null, null], 'Informacion014', 'info_equipo_3_6', 'info_equipo_3_6_btnCerrar', '168');
eventoEquipos('equipo_3_7', 'submenu_3_opciones', 'Camara015', 'CamaraDireccion015', ['4530FTA001A008', null, null], 'Informacion015', 'info_equipo_3_7', 'info_equipo_3_7_btnCerrar', '169');
eventoEquipos('equipo_3_8', 'submenu_3_opciones', 'Camara016', 'CamaraDireccion016', ['4530SAL006', null, null], 'Informacion016', 'info_equipo_3_8', 'info_equipo_3_8_btnCerrar', '170');
eventoEquipos('equipo_3_9', 'submenu_3_opciones', 'Camara017', 'CamaraDireccion017', ['4530PPS242A245', null, null], 'Informacion017', null, null, '172');
